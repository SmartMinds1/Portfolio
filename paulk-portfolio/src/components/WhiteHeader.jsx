...
const Header = ()=> {
  ...
  const [isOpen, setIsOpen] = useState(false);
    ...
    return(
      <>
        <div className="w-[100%] h-12 m-auto flex-row-end justify-between sm:h-14 fixed top-0 left-0 z-50 p-2 pl-[1%] pr-[5%] bg-[rgba(250,249,249,0.7)] backdrop-blur-[5px]">
            <div className="w-40 flex-row-end justify-start">
                <div className="w-7 h-7 bg-[url('/bigStarBlack.png')] bg-contain bg-no-repeat bg-center rotate-270"></div>
                <p className="text-primary text-base sm:text-lg font-extrabold">bizN<span className="text-accent text-base sm:text-lg font-light">utritia</span></p>
            </div>
            
            <div className="sm:block hidden  w-[55%] md:w-[50%] lg:w-[40%]">
                <ul className="text-primary text-xs headerLink flex-row-center justify-evenly w-full h-fit">

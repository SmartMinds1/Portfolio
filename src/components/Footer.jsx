       ...
       <div className="w-full h-90 bg-primary flex flex-col items-center justify-between">
        <div className="flex flex-row items-center justify-evenly w-full h-4/5">
            ...
            <div className="w-1/4 h-full flex flex-col items-start justify-center pl-26">
              <p className="text-xl text-background w-full"> <i>smart</i><span className="text-3xl text-accent  font-bold">ADs</span></p>
              <p className="w-full text-md text-background text-sm mt-4">Ideas that grow, connections that scale.</p>
              <button className="btn-primary text-text bg-accent">Call Now</button>
            </div>
           {/* links div */}
            <div className="w-2/3 h-full flex flex-col justify-evenly">
                <div className="w-full h-fit m-auto flex flex-row items-start justify-evenly pt-6">
                    ...
                    <ul className="footerList gap-3 w-100">
                        ...
                        <li className="text-center"><FontAwesomeIcon icon={faLocationDot} className="text-xl text-accent" />Twiga towers, 6th floor, Room 606, Murang'a Road, Opp Meridian Court Hotel, Nairobi Kenya  </li>
                    </ul>
                </div>

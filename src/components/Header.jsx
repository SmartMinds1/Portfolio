...
const Header = ()=> {
    return(
       <div className="w-full h-24 bg-transparent flex flex-row items-center justify-evenly">
        <div>
          <div className="w-20 h-20 bg-[url('/myLOGO_white_HD.png')] bg-cover"></div>
        </div>
            <p className="text-background text-xl font-extrabold">bizN<span className="text-accent text-2xl font-light">utritia</span></p>

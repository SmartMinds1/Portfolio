...
const PricingCard = ({packageName, packagePrice, packageDes, cta}) => {
    return(
        <div className="w-fit h-fit flex flex-col gap-2 items-center">
            <div className="shadow-xl bg-background w-80 h-130 p-5 rounded-2xl flex flex-col items-center justify-between hover:shadow-2xl transition-all duration-400">
                  <div className="w-[100%] h-[40%] bg-[hsl(0,9%,96%)] rounded-2xl flex flex-col items-center justify-evenly p-2">
                    <h3 className="w-full">{packageName}</h3>
                  ...
                  <div className="w-[100%] text-text-muted h-[55%]">
                    ...
                    <ul className="text-sm flex flex-col justify-evenly gap-3">
                        <li> <FontAwesomeIcon icon={faCheck} className="text-soft-alert text-sm"/> Custom website design</li>
                        <li> <FontAwesomeIcon icon={faCheck} className="text-soft-alert text-sm"/> Custom website design</li>
                        <li> <FontAwesomeIcon icon={faCheck} className="text-soft-alert text-sm"/> Custom website design</li>
                        <li> <FontAwesomeIcon icon={faCheck} className="text-soft-alert text-sm"/> Custom website design</li>
                        <li> <FontAwesomeIcon icon={faCheck} className="text-soft-alert text-sm"/> Custom website design</li>
